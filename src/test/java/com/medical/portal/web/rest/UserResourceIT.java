...
import com.medical.portal.service.mapper.UserMapper;
...
class UserResourceIT {
    ...
    void createUser() throws Exception {
        ...
        managedUserVM.setAddressText(DEFAULT_ADDRESSTEXT);
        managedUserVM.setEgn(DEFAULT_EGN);
        managedUserVM.setBirthDate(DEFAULT_BIRTH_DATE);
        managedUserVM.setGp(DEFAULT_GP);
