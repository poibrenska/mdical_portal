...
import static com.medical.portal.web.rest.AccountResourceIT.TEST_USER_LOGIN;
import static org.assertj.core.api.Assertions.assertThat;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import com.medical.portal.IntegrationTest;
import com.medical.portal.config.Constants;
import com.medical.portal.domain.User;
import com.medical.portal.repository.AuthorityRepository;
import com.medical.portal.repository.UserRepository;
import com.medical.portal.security.AuthoritiesConstants;
import com.medical.portal.service.UserService;
import com.medical.portal.service.dto.AdminUserDTO;
import com.medical.portal.service.dto.PasswordChangeDTO;
import com.medical.portal.web.rest.vm.KeyAndPasswordVM;
import com.medical.portal.web.rest.vm.ManagedUserVM;
...
class AccountResourceIT {
    ...
    private static final String DEFAULT_ADDRESSTEXT = "AAAAAAAAAA";
    private static final String UPDATED_ADDRESSTEXT = "BBBBBBBBBB";

    private static final LocalDate DEFAULT_BIRTH_DATE = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_BIRTH_DATE = LocalDate.now(ZoneId.systemDefault());

    private static final String DEFAULT_EGN = "AAAAAAAAAA";
    private static final String UPDATED_EGN = "BBBBBBBBBB";

    private static final String DEFAULT_PHONE = "088888";
    private static final String UPDATED_PHONE = "099999";

    private static final Boolean DEFAULT_ACTIVE = false;
    private static final Boolean UPDATED_ACTIVE = true;

    private static final Long DEFAULT_GP = 1L;
    private static final Long UPDATED_GP = 2L;
    ...
    void testGetExistingAccount() throws Exception {
        ...
        user.setAddressText(DEFAULT_ADDRESSTEXT);
        user.setEgn(DEFAULT_EGN);
        user.setBirthDate(DEFAULT_BIRTH_DATE);
        user.setGp(DEFAULT_GP);
    ...
    void testRegisterValid() throws Exception {
        ...
        validUser.setAddressText(DEFAULT_ADDRESSTEXT);
        validUser.setEgn(DEFAULT_EGN);
        validUser.setBirthDate(DEFAULT_BIRTH_DATE);
        validUser.setGp(DEFAULT_GP);
        validUser.setPhone(DEFAULT_PHONE);
    ...
    void testRegisterDuplicateLogin() throws Exception {
        ...
        firstUser.setAddressText(DEFAULT_ADDRESSTEXT);
        firstUser.setEgn(DEFAULT_EGN);
        firstUser.setBirthDate(DEFAULT_BIRTH_DATE);
        firstUser.setGp(DEFAULT_GP);
        firstUser.setPhone(DEFAULT_PHONE);
        ...
        secondUser.setAddressText(DEFAULT_ADDRESSTEXT);
        secondUser.setEgn(DEFAULT_EGN);
        secondUser.setBirthDate(DEFAULT_BIRTH_DATE);
        secondUser.setGp(DEFAULT_GP);
        secondUser.setPhone(DEFAULT_PHONE);
    ...
    void testSaveAccount() throws Exception {
        ...
        userDTO.setAddressText(DEFAULT_ADDRESSTEXT);
        userDTO.setEgn(DEFAULT_EGN);
        userDTO.setBirthDate(DEFAULT_BIRTH_DATE);
        userDTO.setGp(DEFAULT_GP);
