...
public class UserMapper {
    ...
    public Patient userDTOToPatient(AdminUserDTO userDTO) {
        if (userDTO == null) {
            return null;
        } else {
            User user = new User();
            ...
            patient.setAddressText(userDTO.getAddressText());
            patient.setEgn(userDTO.getEgn());
            patient.setActive(false);
            patient.setBirthDate(userDTO.getBirthDate());
            patient.setGp(userDTO.getGp());
